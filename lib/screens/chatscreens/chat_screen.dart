...
import 'package:stuxplay/enum/view_state.dart';
import 'package:stuxplay/models/message.dart';
...
import 'package:stuxplay/resources/storage_methods.dart';
import 'package:stuxplay/screens/chatscreens/widgets/cached_image.dart';
import 'package:stuxplay/utils/call_utilities.dart';
...
import 'package:stuxplay/widgets/appbar.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // emojiContainer() {
  //   return EmojiPicker(
  //     bgColor: Palette.separatorColor,
  ...
  //TODO: add circular progressbar in compress image
        ...
        children: <Widget>[
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: Palette.separatorColor,
                  ),
                ),
                // IconButton(
          ...
          isWriting
              ? Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: Palette.stuxGradient, shape: BoxShape.circle),
                  child: IconButton(
                    icon: Icon(
                      Icons.send,
                      size: 15,
